...
public class EditCustomerOrderDialogAction extends AbstractSearchViewDialogAction<CustomerOrder> {
	...
	public EditCustomerOrderDialogAction(CustomerOrderSearchView view) {
